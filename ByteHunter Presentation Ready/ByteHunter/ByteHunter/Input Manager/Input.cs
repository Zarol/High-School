...
namespace ByteHunter.Input_Manager
{
    /// <summary>
    ...
    public static class Input
    {
        ...
        public static Point mouseOffest = new Point(0,0);
#endif
        ...
        public static Point MousePos
        {
            ...
            {
#if !XBOX360
                return new Point(mouseState.X + mouseOffest.X, mouseState.Y + mouseOffest.Y);
#else
                return Point.Zero;
#endif
            }
        ...
        /// </summary>
        /// <returns>Bool</returns>
        public static bool KeyboardSpacePressed
        {
            get
            {
            ...
            get
            {
                return IsNewKeyPress(Keys.Up) ||
                       ...
                       (gamePadState.ThumbSticks.Left.Y > 0 &&
                        gamePadStateLastFrame.ThumbSticks.Left.Y <= 0);
            }
        }
